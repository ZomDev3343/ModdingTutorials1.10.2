...
package fr.zomdev.moddingtutorials.utils;

import fr.zomdev.moddingtutorials.ZomTutoMod;
import fr.zomdev.moddingtutorials.enchants.EnchantmentPoisonDamage;
import fr.zomdev.moddingtutorials.gen.OreGeneration;
...
public class LFTTutoModUtils
{
	...
	{
		public static final ItemArmor.ArmorMaterial mechanical_mat = EnumHelper.addArmorMaterial("machanical_mat", ZomTutoMod.MODID + ":mechanical_armor", 53, new int[]{2, 4, 3, 2}, 13, SoundEvents.BLOCK_ANVIL_PLACE, 0);
	}
